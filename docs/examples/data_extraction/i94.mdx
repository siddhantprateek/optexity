...
Before starting, please look at the [Local Setup](/docs/building_automations/local-setup) guide to setup the environment.
...
The `.env` file should be created in the root of the repository in the [Local Setup](/docs/building_automations/local-setup) guide. This will add the automation to your dashboard.
